...
struct PLEBlockTests {
  ...
  private enum Golden {
    static let emb: [[Float]] = [[0.1875, -0.5625, 0.125, -0.625], [-0.375, 0.3125, -0.4375, 0.25], [0.5, -0.25, 0.4375, -0.3125]]
    static let streams: [[Float]] = [[0.5, -0.25, 0.4375, -0.3125, 0.375, -0.375], [-0.0625, 0.625, -0.125, 0.5625, -0.1875, 0.5], [-0.625, 0.0625, -0.6875, 0.0, 0.6875, -0.0625]]
    static let keyw: [[Float]] = [[-0.3125, 0.375, -0.375, 0.3125], [0.5625, -0.1875, 0.5, -0.25], [0.0, 0.6875, -0.0625, 0.625], [-0.5625, 0.125, -0.625, 0.0625], [0.3125, -0.4375, 0.25, -0.5], [-0.25, 0.4375, -0.3125, 0.375]]
    static let valw: [[Float]] = [[0.3125, -0.4375, 0.25, -0.5], [-0.25, 0.4375, -0.3125, 0.375], [0.625, -0.125, 0.5625, -0.1875]]
    ...
    static let convw: [[Float]] = [[0.25, -0.5], [-0.3125, 0.375], [0.5625, -0.1875], [0.0, 0.6875], [-0.5625, 0.125], [0.3125, -0.4375]]
    static let output: [[Float]] = [[0.6238403291, -0.3289741209, 0.1752113993, 0.3459035830, -0.3631545824, 0.2337877668], [-0.4531542350, 0.2971879841, -0.2880373654, -0.1882201018, 0.2343690958, -0.2724286854], [0.3000576358, -0.2170839640, 0.3508935233, 0.2648555710, -0.0899962438, 0.3661230713]]
  }
}
