...
struct QSAIndexerTests {
  ...
  private enum Golden {
    static let keys: [[Float]] = [[0.1875, -0.5625, 0.125, -0.625], [-0.375, 0.3125, -0.4375, 0.25], [0.5, -0.25, 0.4375, -0.3125], [-0.0625, 0.625, -0.125, 0.5625], [-0.625, 0.0625, -0.6875, 0.0], [0.25, -0.5, 0.1875, -0.5625], [-0.3125, 0.375, -0.375, 0.3125], [0.5625, -0.1875, 0.5, -0.25], [0.0, 0.6875, -0.0625, 0.625]]
    static let q: [[Float]] = [[-0.625, 0.0625, -0.6875, 0.0], [0.25, -0.5, 0.1875, -0.5625], [-0.3125, 0.375, -0.375, 0.3125]]
    static let pooled: [[Float]] = [[-0.09375, -0.125, -0.15625, -0.1875], [0.21875, 0.1875, 0.15625, 0.125], [-0.1875, -0.21875, -0.25, -0.28125], [0.125, 0.09375, 0.0625, 0.03125]]
